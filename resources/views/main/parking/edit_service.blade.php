        ...
        <div class="col-md-10">
            <div class="card card-malle">
                <div class="card-header-malle">
                   <p>Service Id: <span style="margin-right: 120px;color: red">{{ $service->service_id }}</span> <span style="float: right;color: blue"><a href="{{ route('discount-tags') }}">Back</a></span></p>
                </div>
