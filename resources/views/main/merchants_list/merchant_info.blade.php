                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default button_toogle @if($merchant->dine_in=="Y") active @endif" id="yes_dine_in">
                                                <input type="radio" name="dine_in" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default button_toogle @if($merchant->dine_in!="Y") active @endif" id="no_dine_in">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->dine_service=="Y") active @endif" id="yes_dine_in_service">
                                                <input type="radio" name="dine_service" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->dine_service!="Y") active @endif" id="no_dine_in_service">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->dine_gst=="Y") active @endif" id="yes_dine_in_gst">
                                                <input type="radio" name="dine_gst" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->dine_gst!="Y") active @endif" id="no_dine_in_gst">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default button_toogle @if($merchant->take_out=="Y") active @endif" id="yes_take_out">
                                                <input type="radio" name="take_out" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default button_toogle @if($merchant->take_out!="Y") active @endif" id="no_take_out">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->take_out_service=="Y") active @endif" id="yes_take_out_service">
                                                <input type="radio" name="take_out_service" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->take_out_service!="Y") active @endif" id="no_take_out_service">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->take_out_gst=="Y") active @endif" id="yes_take_out_gst">
                                                <input type="radio" name="take_out_gst" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->take_out_gst!="Y") active @endif" id="no_take_out_gst">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->take_out_charge=="Y") active @endif" id="yes_deliver_gst">
                                                <input type="radio" name="take_out_charge" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->take_out_charge!="Y") active @endif" id="no_deliver_gst">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default button_toogle @if($merchant->delivery=="Y") active @endif" id="yes_deliver">
                                                <input type="radio" name="delivery" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default button_toogle @if($merchant->delivery!="Y") active @endif" id="no_deliver">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->deliver_service=="Y") active @endif" id="yes_deliver_service">
                                                <input type="radio" name="deliver_service" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->deliver_service!="Y") active @endif" id="no_deliver_service">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->deliver_gst=="Y") active @endif" id="yes_deliver_gst">
                                                <input type="radio" name="deliver_gst" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->deliver_gst!="Y") active @endif" id="no_deliver_gst">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-default @if($merchant->delivery_charge=="Y") active @endif" id="yes_deliver_gst">
                                                <input type="radio" name="delivery_charge" autocomplete="off" value="Y" class="column_update"> Yes
                                            </label>
                                            <label class="btn btn-default @if($merchant->delivery_charge!="Y") active @endif" id="no_deliver_gst">
