        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="{{route('merchant-company.store')}}" id="addMalltype">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="company_name" placeholder="Enter Company Name"
                                       class="form-control" id="sub_category_name" required="" list="datalist1" data-autocompleturl="{{route('merchant-company.search')}}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped malle-table"  id="mall_type-table"
                                    ...
                                    @foreach($companys as $company)
                                        <tr class="row-location" data-id="{{@$company->company_id}}">
                                            <td>{{ @$company->company_name }}
                                                <br><br>
                                            <span style="float: left" class="link_color"><a href="{{route('merchant-company.edit',[$company->company_id])}}"><b>Main Info</b></a></span>
                                                <span style="margin-left: 20px" class="link_color"><a href="{{route('merchant-company.show',[$company->company_id])}}"><b>Merchants Owned</b></a></span>
                                            </td>
                                            <td>{{ \App\CityMaster::getCityName(@$company->city_id) }}</td>

                                            <td>
                                                <a href="javascript:;"
                                                   data-href="{{route('merchant-company.destroy',[$company->company_id])}}"
