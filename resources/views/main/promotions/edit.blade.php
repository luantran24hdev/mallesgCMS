                ...
                <div class="col-md-2">
                    ...
                    <label class="mb-2 font-12">Active</label><br>
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-default @if($current_promo->promo_active=="Y") active @endif" id="yes_active">
                                    <input type="radio" name="promo_active" autocomplete="off" value="Y" class="column_update_promotion"> Yes
                                </label>
                                <label class="btn btn-default @if($current_promo->promo_active!="Y") active @endif" id="no_active">
