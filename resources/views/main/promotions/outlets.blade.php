        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body">
                        ...
                        <div class="row prom_out">
                            ...
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary col-md-12 top-t"
                                        id="btnMerchantPromotion">{{__('Update')}}</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped malle-table " id="promotion-outlate-table"
                                ...
                                @if(isset($current_promo->outlets))
                                    @foreach($current_promo->outlets as $outlet)
                                        <tr class="row-promotion" data-id="{{$outlet->po_id}}">
                                            ...
                                            <td>
                                                <select name="live" id="" class="column_update dd-orange"
                                                        data-href="{{route('promo-outlets.update',['promo_active' => $outlet->po_id])}}"
                                                        data-method="PUT">
                                                    <option value="Y" @if($outlet->live=='Y') selected @endif>Yes
                                                    </option>
                                                    <option value="N" @if($outlet->live=='N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                            <td>
                                                <select name="featured" id="" class="column_update dd-orange"
                                                        data-href="{{route('promo-outlets.update',['promo_active' => $outlet->po_id])}}"
                                                        data-method="PUT">
                                                    <option value="Y" @if($outlet->featured=='Y') selected @endif>Yes
                                                    </option>
                                                    <option value="N" @if($outlet->featured=='N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                            <td>
                                                <select name="redeem" id="" class="column_update dd-orange"
                                                        data-href="{{route('promo-outlets.update',['promo_active' => $outlet->po_id])}}"
                                                        data-method="PUT">
                                                    <option value="Y" @if($outlet->redeem=='Y') selected @endif>Yes
                                                    </option>
                                                    <option value="N" @if($outlet->redeem=='N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                            <td>

                                                <a href="{{route('promo-outlets.show',['id'=>$id, 'outlate_id'=>$outlet->po_id,'promo_id'=>$outlet->promo_id])}}"
                                                   data="2" class="btn-edit"><span class="text-success">Edit</span></a>
                                                |
                                                &nbsp;
                                                <a href="javascript:;"
                                                   data-href="{{route('promo-outlets.destroy',['promo_active' => $outlet->po_id])}}"
                                                   data-method="DELETE" class="btn-delete" data-id="{{$outlet->po_id}}">
