<div class="row">
    <div class="col-md-10">
        <div class="card card-malle">
            ...
            <div class="card-body" id="promo-image-body1" data-sourceurl="{{route('mall-events.edit',[$event->event_id])}}">
                ...
                <div class="row" id="promo-image-content1">
                    ...
                    @for($i=1;$i<6;$i++)
                        ...
                        @foreach($event_images as $event_image)
                            @if($event_image->event_count == $i)

                                <div class="col-md-4 mb-3 pr-0">
                                    <img class="card-img-top fit-image" src="{{$live_url.$event_image->event_image}}" alt="image count {{$event_image->event_count}}">
                                    {{--<a  href="javascript:;" data-href="" data-method="POST" class="btn-pi-delete" data-id="">--}}
                                    <a  href="javascript:;" data-href="{{route('events.deleteimage',['id'=>$event_image->event_image_id])}}" data-method="POST" class="btn-pi-delete" data-id="{{$event_image->event_count}}">
