    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card card-malle">
                @include('main.country.country_menu')
                <div class="card-body merch_out">
                    <form method="POST" action="{{route('country.store')}}" id="addCategoryTag">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="category-tag-table"
                                    ...
                                    <tr class="row-location" data-id="{{@$country->country_id}}">
                                        <td>{{ @$country->country_name }}</td>
                                        <td>
                                            <a href="javascript:;"
                                               data-href="{{route('country.destroy',[$country->country_id])}}"
