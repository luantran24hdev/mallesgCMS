        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="{{route('city.store')}}" id="addCategoryTag">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="category-tag-table"
                                    ...
                                    <tr class="row-location" data-id="{{@$city->city_id}}">
                                        <td>{{ @$city->city_name }}</td>
                                        <td>{{ @\App\CountryMaster::getCountryName($city->country_id) }}</td>

                                        <td>
                                            <a href="javascript:;"
                                               data-href="{{route('city.destroy',[$city->city_id])}}"
