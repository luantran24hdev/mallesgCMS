        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="{{route('town.store')}}" id="addCategoryTag">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="category-tag-table"
                                    ...
                                    <tr class="row-location" data-id="{{@$town->town_id}}">
                                        <td>{{ @$town->town_name }}</td>
                                        <td>{{ @\App\CityMaster::getCityName($city->city_id) }}</td>

                                        <td>
                                            <a href="javascript:;"
                                               data-href="{{route('town.destroy',[$town->town_id])}}"
