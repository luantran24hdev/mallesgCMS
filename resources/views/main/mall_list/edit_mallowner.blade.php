        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-malle">
                    ...
                    <div class="card-body">
                        <form  method="post" action="{{ route('mall-owner.update',[$owner->mo_id]) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mall_owner_name" placeholder="Mall Name" id="mallname" class="form-control col-md-12" value="{{  $owner->mall_owner_name }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <select name="country_id" class="form-control col-md-12" id="country_select">
                                                @foreach($countries as $country)
                                                    <option value="{{ $country->country_id }}" @if($owner->country_id == $country->country_id) selected @endif>{{$country->country_name }}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown">
                                        <select name="city_id" class="form-control col-md-12" id="city_control">
                                            @foreach($cities as $city)
                                                <option value="{{ $city->city_id }}" @if($city->city_id == $owner->city_id) selected @endif>{{$city->city_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" class="form-control" name="company_address">{{ $owner->company_address}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="postal_code" class="form-control" placeholder="Postal Code" value="{{ $owner->postal_code }}">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website" class="form-control" placeholder="Website" value="{{ $owner->website }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Facebook</label>
                                        <input type="text" name="facebook" id="facebook" placeholder="Facebook" class="form-control" value="{{ $owner->facebook }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Instagram</label>
                                        <input type="text" name="instagram" id="instagram" placeholder="Instagram" class="form-control" value="{{ $owner->instagram }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Twitter</label>
                                        <input type="text" name="twitter" id="twitter" placeholder="Twitter" class="form-control" value="{{ $owner->twitter }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">YouTube</label>
                                        <input type="text" name="youtube" id="youtube" placeholder="YouTube" class="form-control" value="{{ $owner->youtube }}">
                                    </div>
                                </div>
