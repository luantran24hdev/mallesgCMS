                                    ...
                                    <tr class="row-location" data-id="<?php echo e(@$mealgroup->mg_id); ?>">
                                        <td>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <form action="<?php echo e(route('mealgroup.uploadimage')); ?>" class="dropzone" style="width: 60px;height: 60px;min-height: 0px !important; padding: 0 0 0 0 !important;">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="mg_id" value="<?php echo e(@$mealgroup->mg_id); ?>">
                                                </form>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status==='error'){
                            ...
                            window.location.href = '<?php echo e(route('meal-group')); ?>';
                        }
                    }
                });
