        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="<?php echo e(route('mall-owner.store')); ?>" id="addMalltype">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="mall_owner_name" placeholder="Enter Company Name"
                                       class="form-control" id="sub_category_name" required="" list="datalist1" data-autocompleturl="<?php echo e(route('mall-owner.search')); ?>">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped malle-table"  id="mall_type-table"
                                    ...
                                    <?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="row-location" data-id="<?php echo e(@$owner->mo_id); ?>">
                                            <td><?php echo e(@$owner->mall_owner_name); ?>
                                            ...
                                            <td>
                                                <a href="javascript:;"
                                                   data-href="<?php echo e(route('mall-owner.destroy',[$owner->mo_id])); ?>"
                                                   data-method="DELETE" class="btn-delete"
                                                   data-id="<?php echo e($owner->mo_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/mall_list/owner.blade.php ENDPATH**/ ?>