        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-malle">
                    ...
                    <div class="card-body">
                        <form  method="post" action="<?php echo e(route('mall-owner.update',[$owner->mo_id])); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Mall Owner Name</label>
                                        <input type="text" name="mall_owner_name" placeholder="Mall Name" id="mallname" class="form-control col-md-12" value="<?php echo e($owner->mall_owner_name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <select name="country_id" class="form-control col-md-12" id="country_select">
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($country->country_id); ?>" <?php if($owner->country_id == $country->country_id): ?> selected <?php endif; ?>><?php echo e($country->country_name); ?></option>
                                    ...
                                    <div class="dropdown">
                                        <select name="city_id" class="form-control col-md-12" id="city_control">
                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($city->city_id); ?>" <?php if($city->city_id == $owner->city_id): ?> selected <?php endif; ?>><?php echo e($city->city_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" class="form-control" name="company_address"><?php echo e($owner->company_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="postal_code" class="form-control" placeholder="Postal Code" value="<?php echo e($owner->postal_code); ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telephone" class="form-control" placeholder="Telephone" value="<?php echo e($owner->telephone); ?>">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website" class="form-control" placeholder="Website" value="<?php echo e($owner->website); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Facebook</label>
                                        <input type="text" name="facebook" id="facebook" placeholder="Facebook" class="form-control" value="<?php echo e($owner->facebook); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Instagram</label>
                                        <input type="text" name="instagram" id="instagram" placeholder="Instagram" class="form-control" value="<?php echo e($owner->instagram); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">Twitter</label>
                                        <input type="text" name="twitter" id="twitter" placeholder="Twitter" class="form-control" value="<?php echo e($owner->twitter); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-2 font-12">YouTube</label>
                                        <input type="text" name="youtube" id="youtube" placeholder="YouTube" class="form-control" value="<?php echo e($owner->youtube); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/mall_list/edit_mallowner.blade.php ENDPATH**/ ?>