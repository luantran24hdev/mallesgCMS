        ...
        $( function() {
            ...
            $(document).on('click','.upload-result', function (ev) {
                $uploadCrop.croppie('result', {
                    ...
                    fd.append("preference_id", "<?php echo e(@$tagMaster->preference_id); ?>");

                    // console.log(fd);
                    $.ajax({
                        url: "<?php echo e(route('preference.tag.uploadimage')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/malle/public_html/adminlaravel3/resources/views/main/preference_tag/edit_tags.blade.php ENDPATH**/ ?>