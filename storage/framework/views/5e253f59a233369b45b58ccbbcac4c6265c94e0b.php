        ...
        <div class="col-md-10">
            <div class="card card-malle">
                <div class="card-header-malle">
                    <p>Category Id: <span style="margin-right: 120px;color: red"><?php echo e($merchanttype->mt_id); ?></span> | Created On: <span style="margin-right: 120px;color: red"><?php echo e(@$merchanttype->dated); ?></span> | Created By: <span style="color: red"><?php echo e(\App\User::getUserName( $merchanttype->user_id)); ?></span> <span style="float: right;color: blue"><a href="<?php echo e(route('merchant-type')); ?>">Back</a></span></p>
                </div>
                <div class="card-body" id="tag-image-body" data-sourceurl="<?php echo e(route('merchant-type.edit',[$merchanttype->mt_id])); ?>">
                    <form method="PATCH" action="<?php echo e(route('merchant-type.update',[$merchanttype->mt_id])); ?>" id="editCategoryTag">
                    <div class="row merch_out" id="tag-image-content">

                            <div class="col-md-3">

                                <?php if($merchanttype->image): ?>
                                    <div class="col-md-12 mb-3 pr-0">
                                        <img class="card-img-top fit-image" src="<?php echo e($live_url.$merchanttype->image); ?>" alt="image count">
                                        <a  href="javascript:;" data-href="<?php echo e(route('merchanttype.deleteimage',['id'=>$merchanttype->mt_id])); ?>" data-method="POST" class="btn-pi-delete" data-id="<?php echo e($merchanttype->mt_id); ?>">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="type" placeholder="Enter type name" id="sub_category_name"
                                       class="form-control" required="" list="datalist1" value="<?php echo e($merchanttype->type); ?>">
                            </div>
        ...
        $( function() {
            ...
            $(document).on('click','.upload-result', function (ev) {
                $uploadCrop.croppie('result', {
                    ...
                    fd.append("mt_id", "<?php echo e(@$merchanttype->mt_id); ?>");

                    // console.log(fd);
                    $.ajax({
                        url: "<?php echo e(route('merchanttype.uploadimage')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/merchants_list/edit_merchanttype.blade.php ENDPATH**/ ?>