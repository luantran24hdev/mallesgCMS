        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="<?php echo e(route('town.store')); ?>" id="addCategoryTag">
                    <div class="row">
                        <div class="col-md-3">
                            <input type="text" name="town_name" placeholder="Enter City Name" id="sub_category_name"
                                   class="form-control" required="" list="datalist1" data-autocompleturl="<?php echo e(route('category.tag.search')); ?>">
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <select id="main_category_select" name="city_id" required>
                                    <?php if(!empty($citys)): ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="category-tag-table"
                                       data-sourceurl="<?php echo e(route('town')); ?>">
                                    <thead>
                                    <th>Town Name</th>
                                    <th>City Name</th>
                                    <th>Action</th>
                                    ...
                                    <tr class="row-location" data-id="<?php echo e(@$town->town_id); ?>">
                                        <td><?php echo e(@$town->town_name); ?></td>
                                        <td><?php echo e(@\App\CityMaster::getCityName($city->city_id)); ?></td>

                                        <td>
                                            <a href="javascript:;"
                                               data-href="<?php echo e(route('town.destroy',[$town->town_id])); ?>"
                                               data-method="DELETE" class="btn-delete"
                                               data-id="<?php echo e($town->town_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/country/town.blade.php ENDPATH**/ ?>