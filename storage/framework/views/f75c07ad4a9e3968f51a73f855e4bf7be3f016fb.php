    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('level.store')); ?>" id="addlevel">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="discount-tag-table"
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $level_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="row-location" data-id="<?php echo e(@$level->level_id); ?>">
                                        <td>
                                            <?php if(!empty($level->level_image)): ?>
                                                <img src="<?php echo e($live_url.$level->level_image); ?>" width="50px" height="50px">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('level.edit',[$level->level_id])); ?>"><span class="text-info">Edit</span></a>
                                            |
                                            <a href="javascript:;"
                                               data-href="<?php echo e(route('level.destroy',[$level->level_id])); ?>"
                                               data-method="DELETE" class="btn-delete"
                                               data-id="<?php echo e($level->level_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/level/index.blade.php ENDPATH**/ ?>