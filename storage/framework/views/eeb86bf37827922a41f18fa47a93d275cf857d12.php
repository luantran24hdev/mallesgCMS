        ...
        <div class="col-md-10">
            <div class="card card-malle">
                ...
                <div class="card-body merch_out">
                    <form method="POST" action="<?php echo e(route('country.store')); ?>" id="addCategoryTag">
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" name="country_name" placeholder="Enter Country Name" id="sub_category_name"
                                   class="form-control" required="" list="datalist1">
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="country_code" placeholder="Enter Country Code" id="sub_category_name"
                                   class="form-control" required="" list="datalist1">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped malle-table" id="category-tag-table"
                                       data-sourceurl="<?php echo e(route('country')); ?>">
                                    <thead>
                                    <th>Country Name</th>
                                    <th>Action</th>
                                    </thead>
                                    ...
                                    <tr class="row-location" data-id="<?php echo e(@$country->country_id); ?>">
                                        <td><?php echo e(@$country->country_name); ?></td>
                                        <td>
                                            <a href="javascript:;"
                                               data-href="<?php echo e(route('country.destroy',[$country->country_id])); ?>"
                                               data-method="DELETE" class="btn-delete"
                                               data-id="<?php echo e($country->country_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adminlaravel3\resources\views/main/country/country.blade.php ENDPATH**/ ?>